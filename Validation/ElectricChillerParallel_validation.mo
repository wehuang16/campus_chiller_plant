...
model ElectricChillerParallel_validation
  ...
  replaceable Plants.Subsequences.ElectricChillerParallel          pla(
    perChi=perChi,
    dTApp=dTApp,
    perCHWPum=perCHWPum,
    perCWPum=perCWPum,
...
equation
  ...
  connect(vol.ports[1], res.port_a) annotation (Line(points={{59,20},{80,20},{
  ...
  connect(on.y,pla.on)
    annotation (Line(points={{-39,-10},{-38,-10},{-38,-2.66667},{-10.6667,
          -2.66667}},
      color={255,0,255}));
  connect(weaDat.weaBus,pla.weaBus)
    annotation (Line(points={{-40,30},{0,30},{0,0}},
      color={255,204,51}));
  ...
  connect(pla.port_bSerCoo, vol.ports[2]) annotation (Line(points={{10,-11.3333},
          {20,-11.3333},{20,20},{61,20}}, color={0,127,255}));
  connect(pla.TCHWSupSet, TCHWSupSet.y) annotation (Line(points={{-10.6667,
          -4.66667},{-30,-4.66667},{-30,-50},{-39,-50}},
                                               color={0,0,127}));
  annotation (
    Icon(
      coordinateSystem(
...
First implementation.
    ...
    __Dymola_Commands(
      ...
      "Simulate and Plot"));
end ElectricChillerParallel_validation;
