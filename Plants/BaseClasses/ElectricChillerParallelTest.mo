within campus_chiller_plant.Plants.BaseClasses;
model ElectricChillerParallelTest "District cooling plant model"
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFloCHW(redeclare final package
      Medium = Medium) "Total chilled water pump mass flow rate" annotation (
